...
-- =============================================================
-- Phase 148: no fixed administrator seed. Open admin/setup.php once to create the first Super Admin securely.
...
-- =============================================================
-- Phase 148 critical backend hardening / normalization
-- =============================================================
...
-- Phase 150 owner-lock security marker. Fresh installs have no admins yet; first-run setup creates the single protected owner.
DELETE rp FROM admin_role_permissions rp
JOIN admin_permissions p ON p.id=rp.permission_id AND p.permission_key='admins.manage'
JOIN admin_roles r ON r.id=rp.role_id
WHERE r.role_key<>'super_admin';
