...
<div class="panel-card"><h2>Important</h2><p>Import <code>sql/wellfare_english_complete.sql</code> once. It contains all 40 tables, all later columns and default module data. Keep <code>APP_ALLOW_SCHEMA_UPDATES=false</code> for normal production traffic. Always take a database backup before importing into an existing database.</p></div>
